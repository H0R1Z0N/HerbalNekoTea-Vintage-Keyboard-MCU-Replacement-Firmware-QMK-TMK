...
#include <usb/keys.h>
#include <kbmatrix/PC8801-Compact.h>
...
const static struct keystate nexttab_key = {9, 5, 0};
const static struct keystate prevtab_key = {9, 4, 0};
...
const struct kblayer PROGMEM kblayer_list[LAYERS] = {
	{
		...
		MATRIX_POS(
			...
			KEY_X,		KEY_Y,		KEY_Z,		RBRACE,		KEY_EQUAL,	KEY_TILDE,	KEY_EQUAL,	KEY_MINUS,	//5
			KEY_0,		KEY_1,		KEY_2,		KEY_3,		KEY_4,		KEY_5,		KEY_6,		KEY_7,		//6
			KEY_8,		KEY_9,		KEY_QUOTE,	KEY_SEMI,	KEY_COMMA,	KEY_PERIOD,	KEY_SLASH,	BACKSLASH,	//7
			LEFT_GUI,	KEY_UP,		KEY_RIGHT,	BACKSPACE,	LEFT_ALT,	0,			LSHIFT,		LCTRL,		//8
			KEY_HOME,	0,			0,			0,			0,			0,			KEY_SPACE,	KEY_ESC,	//9
			KEY_TAB,	KEY_DOWN,	KEY_LEFT,	RIGHT_ALT,	PRTSCN,		0,			KEYPAD_SLH, LOCKING_C,	//10
	...
	
	{
		...
		MATRIX_POS(
			...
			KEY_H,		KEY_I,		KEY_J,		KEY_K,		KEY_L,		KEY_M,		KEY_N,		KEY_O,		//3
			KEY_P,		KEY_Q,		KEY_R,		KEY_S,		KEY_T,		KEY_U,		KEY_V,		KEY_W,		//4
			KEY_X,		KEY_Y,		KEY_Z,		RBRACE,		KEY_EQUAL,	KEY_TILDE,	KEY_F12,	KEY_F11,	//5
			KEY_F10,	KEY_F1,		KEY_F2,		KEY_F3,		KEY_F4,		KEY_F5,		KEY_F6,		KEY_F7,		//6
			KEY_F8,		KEY_F9,		KEY_QUOTE,	KEY_SEMI,	KEY_COMMA,	KEY_PERIOD,	KEY_SLASH,	BACKSLASH,	//7
			LEFT_GUI,	KEY_UP,		KEY_RIGHT,	BACKSPACE,	LEFT_ALT,	0,			LSHIFT,		LCTRL,		//8
			KEY_HOME,	0,			0,			0,			0,			0,			KEY_SPACE,	KEY_ESC,	//9
			KEY_TAB,	KEY_DOWN,	KEY_LEFT,	RIGHT_ALT,	PRTSCN,		0,			KEYPAD_SLH, LOCKING_C,	//10
			PAGE_UP,	PAGE_DOWN																			//11
	...
	
	{
		...
		MATRIX_POS(
			...
			KEY_0,		KEY_1,		KEY_2,		KEY_3,		KEY_4,		KEY_5,		KEY_6,		KEY_7,		//6
			KEY_8,		KEY_9,		KEY_QUOTE,	KEY_SEMI,	KEY_COMMA,	KEY_PERIOD,	KEY_SLASH,	BACKSLASH,	//7
			NUMLOCK,	KEY_UP,		KEY_RIGHT,	BACKSPACE,	LEFT_ALT,	0,			LSHIFT,		LCTRL,		//8
			KEY_HOME,	0,			0,			0,			0,			0,			KEY_SPACE,	KEY_ESC,	//9
			KEY_TAB,	KEY_DOWN,	KEY_LEFT,	RIGHT_ALT,	PRTSCN,		0,			KEYPAD_SLH, LOCKING_C,	//10
			PAGE_UP,	PAGE_DOWN																			//11
		)
