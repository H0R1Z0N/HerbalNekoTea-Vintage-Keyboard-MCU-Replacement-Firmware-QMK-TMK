...
const action_t actionmaps[][UNIMAP_ROWS][UNIMAP_COLS] PROGMEM = {
    ...
    */
    UNIMAP_PC98(
    ESC,  MPLY,     F1,  F2,  F3,  F4,  F5,            F6,  F7,  F8,  F9,  F10,        F11, F12, MUTE, VOLD, VOLU,
    GRV, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, NUBS,BSPC,  PSCR, DEL,   HOME,END, PMNS,PSLS,
    TAB,      Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,       PGDN,PGUP,  P7,  P8,  P9,  PAST,
    LCTL,CAPS,A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,BSLS,ENT,      UP,      P4,  P5,  P6,  PPLS,
    LSFT,     Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH, RCTRL,   APP,  LEFT,RGHT,  P1,  P2,  P3,  PEQL,
         LCTRL,LGUI,LGUI,LALT,        SPC,        RALT,RALT,RGUI,APP,              DOWN,    P0,  PCMM,PDOT,PENT
    ),
};
