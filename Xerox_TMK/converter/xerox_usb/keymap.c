...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    F11, F12, ESCAPE, 1, 2, 3, 4, 5, 6, 7, 8, 9, 0,MINS, EQL, BSPC,      PPLS,PMNS,PAST,PSLS,
    HOME, PGUP, TAB, Q, W, E, R, T, Y, U, I, O, P, LBRC, RBRC, ENTER,       NLCK,P7,P8,P9,
    END, PGDN, CAPS, A, S, D, F, G, H, J, K, L, SCLN,QUOT, GRV,              PENT,P4,P5,P6,
    UP, DOWN, LSFT, Z, X, C, V, B, N, M, COMM, DOT, SLSH, RSFT,                P1,P2,P3,
    LEFT, RGHT,LCTL,                         SPC,                                   LALT,                 P0,PDOT,PCMM
    ),
};
